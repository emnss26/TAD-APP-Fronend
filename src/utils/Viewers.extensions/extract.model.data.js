...
class ModeDataExtractionExtension extends Autodesk.Viewing.Extension {
    ...
    onToolbarCreated() {
        this._group = this.viewer.toolbar.getControl('allDataExtractionControls') || new Autodesk.Viewing.UI.ControlGroup('allDataExtractionControls');
                        ...
                        const event = new CustomEvent('dbIdDataExtracted', {
                            detail: {
                                ...
                                properties: data.properties.reduce((acc, prop) => {
                                    acc[prop.displayName] = prop.displayValue || 'no especificado';
                                    return acc;
                                }, {})
                            }
                        });
