        ...
        <footer className="bg-[#2ea3e3] text-white py-2 px-2">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
              <h2 className="text-sm font-medium">TAD | Taller de Arquitectura Digital</h2>
            ...
            <div className="flex flex-col items-center md:items-end mt-1 md:mt-0">
              ...
              <p className="text-xs mt-1">&copy; {new Date().getFullYear()} TAD Hub. All rights reserved.</p>
            </div>
          </div>
        </footer>
      );
