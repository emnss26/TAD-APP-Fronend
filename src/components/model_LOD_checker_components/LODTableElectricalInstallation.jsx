...
const initialData = [
  ...
  { id: 7,  concepto: "Electrical Fixtrue",               lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" }, 
...
export function LODTableElectricalCompliance() {
      ...
      <Card className="mb-2 bg-white">
        <CardContent className="py-1 px-2">
          <div className="flex justify-between items-center">
            <h2 className="text-sm font-bold text-black">ELECTRICAL LOD CHECK</h2>
