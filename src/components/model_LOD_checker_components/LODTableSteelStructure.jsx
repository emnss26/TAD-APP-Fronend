...
const initialData = [
  { id: 1,  concepto: "Strcutrual Steel Columns",                  lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 2,  concepto: "Structural Steel Framings",                           lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 3,  concepto: "Truss",               lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 4,  concepto: "Joist", lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 5,  concepto: "Connections",                            lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 6,  concepto: "Floors & Metal Deck",                          lodRequerido: 300, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 7,  concepto: "Stairs",               lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 8, concepto: "Brace",                    lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
...
export function LODTableSteelStructureCompliance() {
      ...
      <Card className="mb-2 bg-white">
        <CardContent className="py-1 px-2">
          <div className="flex justify-between items-center">
            <h2 className="text-sm font-bold text-black">STEEL STRUCTURE LOD CHECK</h2>
