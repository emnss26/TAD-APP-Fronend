...
const initialData = [
  ...
  { id: 7,  concepto: "Plumbing Accessory",                          lodRequerido: 300, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 8,  concepto: "Plumbing Fittings",                          lodRequerido: 300, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 9,  concepto: "HVAC Ducts",                          lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 10, concepto: "HVAC Duct Fittings",                          lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 11, concepto: "HVAC Duct Accessory",                          lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" }, 
  { id: 12, concepto: "HVAC Equipment",                          lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 13, concepto: "HVAC Terminal Units",                          lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
...
export function LODTableMechanicalCompliance() {
      ...
      <Card className="mb-2 bg-white">
        <CardContent className="py-1 px-2">
          <div className="flex justify-between items-center">
            <h2 className="text-sm font-bold text-black">MECHANICAL LOD CHECK</h2>
