...
const initialData = [
  ...
  { id: 3,  concepto: "Structural Columns",               lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 4,  concepto: "Strucutral Framings", lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 5,  concepto: "Roofs",                            lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 6,  concepto: "Stairs",                          lodRequerido: 300, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 7,  concepto: "Railings",               lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
  { id: 8, concepto: "Strucutral Stiffener & Connections",                    lodRequerido: 350, geometriaCompleta: { y:false,n:false,na:false }, lodCompletion: { y:false,n:false,na:false }, comentarios: "" },
];
...
export function LODTableConcreteStructureCompliance() {
      ...
      <Card className="mb-2 bg-white">
        <CardContent className="py-1 px-2">
          <div className="flex justify-between items-center">
            <h2 className="text-sm font-bold text-black">CONCRETE STRUCTURE LOD CHECK</h2>
