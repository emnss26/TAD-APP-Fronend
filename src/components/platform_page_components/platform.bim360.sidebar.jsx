...
const BIM360SideBar = () => {
  ...
  return (
    <div
      className={`min-h-screen bg-[#f6f6f6] text-[#6b7474] p-4 flex flex-col relative 
    ...
    >
      ...
      <Link
        to={`/bim360projects/${accountId}/${projectId}/bim3604ddata`}
        className="mb-4 flex items-center text-[#6b7474] bg-transparent hover:text-[#2ea3e3] hover:bg-gray-50 p-2 rounded"
      >
      ...
      <Link
        to={`/bim360projects/${accountId}/${projectId}/bim3605ddata`}
        className="mb-4 flex items-center text-[#6b7474] bg-transparent hover:text-[#2ea3e3] hover:bg-gray-50 p-2 rounded"
      >
      ...
      <Link
        to={`/bim360projects/${accountId}/${projectId}/bim3606ddata`}
        className="mb-4 flex items-center text-[#6b7474] bg-transparent hover:text-[#2ea3e3] hover:bg-gray-50 p-2 rounded"
      >
        <FaTools size={10} />
